...
OutputBaseFilename=LF_ServiceApp_1.32_Installer
...
[Files]
Source: "E:\STM32_VSCodeWorkSpace\LineFollower_Light\40_ServiceApplication_QT\Release_1.32\{#MyAppExeName}"; DestDir: "{app}"; Flags: ignoreversion
Source: "E:\STM32_VSCodeWorkSpace\LineFollower_Light\40_ServiceApplication_QT\Release_1.32\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
