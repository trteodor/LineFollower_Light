...
//    qDebug() << "ok iam here";
    ...
    if( (0 == ExpectingFrameNumber) && (BLE_MessID == BleDataManager::BLE_BaseDataReport_part1)  && (PrevSyncId != _inputSyncId))
    {
        ...
        IncomingLfBaseData.CurrSensorData.LastLeftLinePosConfidence =((uint8_t)value.at(18)) ;
        IncomingLfBaseData.CurrSensorData.LastRightLinePosConfidence =((uint8_t)value.at(19)) ;
    ...
    else if( (1 == ExpectingFrameNumber) && (BLE_MessID == BleDataManager::BLE_BaseDataReport_part2)  && (PrevSyncId == _inputSyncId))
    {
        ...
        IncomingLfBaseData.CurrMapData.PosO =ieee_uint32_AsBitsTo_float32(ConvToUint32(value,10)) ;
        IncomingLfBaseData.CurrMapData.TravelledDistance =ieee_uint32_AsBitsTo_float32(ConvToUint32(value,14)) ;

        IncomingLfBaseData.CurrSensorData.SensorData[0] =((uint8_t)value.at(18)) ;
        IncomingLfBaseData.CurrSensorData.SensorData[1] =((uint8_t)value.at(19)) ;
    ...
    else
    {
        ...
        {
            IncomingLfBaseData.CurrSensorData.SensorData[2] =((uint8_t)value.at(2)) ;
            IncomingLfBaseData.CurrSensorData.SensorData[3] =((uint8_t)value.at(3)) ;
            IncomingLfBaseData.CurrSensorData.SensorData[4] =((uint8_t)value.at(4)) ;
            IncomingLfBaseData.CurrSensorData.SensorData[5] =((uint8_t)value.at(5)) ;
            IncomingLfBaseData.CurrSensorData.SensorData[6]  =((uint8_t)value.at(6)) ;
            IncomingLfBaseData.CurrSensorData.SensorData[7]  =((uint8_t)value.at(7)) ;
            IncomingLfBaseData.CurrSensorData.SensorData[8]  =((uint8_t)value.at(8)) ;
            IncomingLfBaseData.CurrSensorData.SensorData[9]  =((uint8_t)value.at(9)) ;
            IncomingLfBaseData.CurrSensorData.SensorData[10] =((uint8_t)value.at(10)) ;
            IncomingLfBaseData.CurrSensorData.SensorData[11] =((uint8_t)value.at(11)) ;

            IncomingLfBaseData.CurrSensorData.PosError =ieee_uint32_AsBitsTo_float32(ConvToUint32(value,12));
            IncomingLfBaseData.LinePidRegData.PidRegCorrValue = ieee_uint32_AsBitsTo_float32(ConvToUint32(value,16));
            ...
            emit BleDatMngrSignal_PlotPidRegValAppendData(FullFrameCounter,IncomingLfBaseData.LinePidRegData.PidRegCorrValue);
...
void BleDataManager::BleDatMngr_MotorsFactorsDataHandler(const QByteArray &value,BleDataManager::BLE_MessageID_t BLE_MessID)
{
//    uint32_t FacA_Lft  = 0U,FacA_Rgt = 0U, FacB_Lft = 0U,FacB_Rht = 0U;

    (void)BLE_MessID;
    uint32_t FacA_Lft    = ConvToUint32(value,2);
    uint32_t FacA_Rgt    = ConvToUint32(value,6);
    uint32_t FacB_Lft    = ConvToUint32(value,10);
    uint32_t FacB_Rht    = ConvToUint32(value,14);

    emit BleDatMngrSignal_UpdateMotorsFactors(FacA_Lft,FacA_Rgt,FacB_Lft,FacB_Rht);
}

void BleDataManager::BleDatMngr_EncodersCfgDataHandler(const QByteArray &value,BleDataManager::BLE_MessageID_t BLE_MessID)
{
    (void)BLE_MessID;
    float OneImpDist    = ieee_uint32_AsBitsTo_float32(ConvToUint32(value,2));
    float WheelBase    = ieee_uint32_AsBitsTo_float32(ConvToUint32(value,6));
...
void BleDataManager::BleDatMngr_InputHanlder(const QByteArray &value)
{
    ...
    switch(BLE_MessageID)
    {
        ...
        {
            BleDatMngr_MotorsFactorsDataHandler(value,BLE_MessageID);
            break;
        }
        ...
        {
            BleDatMngr_EncodersCfgDataHandler(value,BLE_MessageID);
            break;
        }
